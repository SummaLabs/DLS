...
_SOLVERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='per_parameter_reduce', full_name='caffe.SolverParameter.per_parameter_reduce', index=40,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detectnet_groundtruth_param', full_name='caffe.LayerParameter.detectnet_groundtruth_param', index=58,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='detectnet_augmentation_param', full_name='caffe.LayerParameter.detectnet_augmentation_param', index=59,
...
_BATCHNORMPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='engine', full_name='caffe.BatchNormParameter.engine', index=5,
...
class DetectNetGroundTruthParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType

  class ClassMapping(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class DetectNetAugmentationParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
