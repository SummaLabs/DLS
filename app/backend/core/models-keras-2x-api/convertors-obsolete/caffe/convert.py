...
def caffe_to_keras(prototextPath, caffemodelPath=None, phase='train', debug=False):
        '''
        ...
        prototextPath = preprocessPrototxt(prototextPath, debug)
        google.protobuf.text_format.Merge(prototextPath, config)
