...
def download_file_url():
    ...
    return flask.send_file(safe_join(REPOSITORY_BASE_PATH, path),  mimetype='image/gif')
...
def unzip():
    ...
    logger.info(" unzipping file " + REPOSITORY_BASE_PATH +
                filename + " to " + path)
