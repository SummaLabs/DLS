...
function ConstructorController($mdDialog, $mdToast, $location, $scope, taskManagerService, networkDataService, networkLayerService, modelsService, coreService, appConfig) {
    var self = this;
